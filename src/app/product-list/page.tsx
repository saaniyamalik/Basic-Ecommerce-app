    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
      <div className="bg-white flex flex-col rounded overflow-hidden shadow-md cursor-pointer hover:scale-[1.01] transition-all">
        <div className="w-full">
          <img src="image/full-sleeves.webp" alt="Product 1"
      ...
      <div className="bg-white flex flex-col rounded overflow-hidden shadow-md cursor-pointer hover:scale-[1.01] transition-all">
        <div className="w-full">
          <img src="image/pic-2.webp" alt="Product 2"
            className="w-full object-cover object-top aspect-[230/307]" />
        </div>
      ...
      <div className="bg-white flex flex-col rounded overflow-hidden shadow-md cursor-pointer hover:scale-[1.01] transition-all">
        <div className="w-full">
          <img src="image/pic-3.webp" alt="Product 3"
            className="w-full object-cover object-top aspect-[230/307]" />
        </div>
      ...
      <div className="bg-white flex flex-col rounded overflow-hidden shadow-md cursor-pointer hover:scale-[1.01] transition-all">
        <div className="w-full">
          <img src="image/pic-4.jpg" alt="Product 4"
            className="w-full object-cover object-top aspect-[230/307]" />
        </div>
      ...
      <div className="bg-white flex flex-col rounded overflow-hidden shadow-md cursor-pointer hover:scale-[1.01] transition-all">
        <div className="w-full">
          <img src="image/half-sleeves.jpg" alt="Product 5"
            className="w-full object-cover object-top aspect-[230/307]" />
        </div>
      ...
      <div className="bg-white flex flex-col rounded overflow-hidden shadow-md cursor-pointer hover:scale-[1.01] transition-all">
        <div className="w-full">
          <img src="image/pic-5.jpg" alt="Product 3"
            className="w-full object-cover object-top aspect-[230/307]" />
        </div>
      ...
      <div className="bg-white flex flex-col rounded overflow-hidden shadow-md cursor-pointer hover:scale-[1.01] transition-all">
        <div className="w-full">
          <img src="image/pic-6.avif" alt="Product 3"
            className="w-full object-cover object-top aspect-[230/307]" />
        </div>
      ...
      <div className="bg-white flex flex-col rounded overflow-hidden shadow-md cursor-pointer hover:scale-[1.01] transition-all">
        <div className="w-full">
          <img src="image/pic-7.webp" alt="Product 3"
            className="w-full object-cover object-top aspect-[230/307]" />
        </div>

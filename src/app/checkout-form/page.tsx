              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="flex items-center">
                  ...
                  <label htmlFor="card" className="ml-4 flex gap-2 cursor-pointer">
                    <img src="image/visa.jpg" className="w-12" alt="card1" />
                    <img src="image/easypaisa.png" className="w-12" alt="card2" />
                    <img src="image/hbl.jpeg" className="w-12" alt="card3" />
                  </label>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <label htmlFor="paypal" className="ml-4 flex gap-2 cursor-pointer">
                    <img src="image/paypal.png" className="w-20" alt="paypalCard" />
                  </label>
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-4 gap-4 mt-4">
                <div className="col-span-2">
                  <input type="number" placeholder="Card number"
                    className="py-3 bg-white text-gray-800 w-full text-sm border-2 rounded-md focus:border-blue-500 outline-none" />
                </div>
                <div>

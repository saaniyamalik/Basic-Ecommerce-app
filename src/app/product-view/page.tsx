        ...
        <div className="col-span-2 grid grid-cols-2 lg:sticky top-0 gap-0.5">
          <div className="columns-2 gap-0.5 space-y-0.5">
            <div className="overflow-hidden">
              <img src="image/pic-2.webp" alt="Product" className="w-full aspect-[253/337] object-cover object-top shadow-md hover:scale-[1.05] transition-all duration-300" />
            </div>
            <div className="overflow-hidden">
              <img src="image/pic-3.webp" alt="Product" className="w-full aspect-[253/337] object-cover object-top shadow-md hover:scale-[1.05] transition-all duration-300" />
            </div>
            <div className="overflow-hidden">
              <img src="image/pic-4.jpg" alt="Product" className="w-full aspect-[253/337] object-cover object-top shadow-md hover:scale-[1.05] transition-all duration-300" />
            </div>
            <div className="overflow-hidden">
              <img src="image/pic-5.jpg" alt="Product" className="w-full aspect-[253/337] object-cover object-top shadow-md hover:scale-[1.05] transition-all duration-300" />
            </div>
          </div>
          <div className="overflow-hidden">
            <img src="image/pic-6.avif" alt="Product" className="w-full aspect-[3/4] object-cover object-top shadow-md hover:scale-[1.05] transition-all duration-300" />
          </div>
        </div>
        ...
        <div className="py-6 px-8 max-lg:max-w-2xl">
          ...
          <div className="mt-6">
            <div className="flex items-center flex-wrap gap-4">
              ...
              <p className="text-gray-400 text-sm mt-2"><p>$42</p> <span className="ml-1">Tax included</span></p>
            </div>
          </div>

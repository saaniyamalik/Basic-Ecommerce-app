export default function ProductList () {
    ...
    return (
          ...
          <div className="col-span-2 grid grid-cols-2 lg:sticky top-0 gap-0.5">
            <div className="columns-2 gap-0.5 space-y-0.5">
              <div className="overflow-hidden">
                <img src="https://readymadeui.com/images/product6.webp" alt="Product" className="w-full aspect-[253/337] object-cover object-top shadow-md hover:scale-[1.05] transition-all duration-300" />
              </div>
              <div className="overflow-hidden">
                <img src="https://readymadeui.com/images/product3.webp" alt="Product" className="w-full aspect-[253/337] object-cover object-top shadow-md hover:scale-[1.05] transition-all duration-300" />
              </div>
              <div className="overflow-hidden">
                <img src="https://readymadeui.com/images/product5.webp" alt="Product" className="w-full aspect-[253/337] object-cover object-top shadow-md hover:scale-[1.05] transition-all duration-300" />
              </div>
              <div className="overflow-hidden">
                <img src="https://readymadeui.com/images/product2.webp" alt="Product" className="w-full aspect-[253/337] object-cover object-top shadow-md hover:scale-[1.05] transition-all duration-300" />
              </div>
            </div>
            <div className="overflow-hidden">
              <img src="https://readymadeui.com/images/product6.webp" alt="Product" className="w-full aspect-[3/4] object-cover object-top shadow-md hover:scale-[1.05] transition-all duration-300" />
            </div>
          </div>

          <div className="py-6 px-8 max-lg:max-w-2xl">
            <div>
              <h2 className="text-xl font-bold text-gray-800">Adjective Attire | T-shirt</h2>
            ...
            <div className="mt-6">
              <div className="flex items-center flex-wrap gap-4">
                ...
                <p className="text-gray-400 text-sm mt-2"><span className="ml-1">Tax included</span></p>
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-4 mt-4">
                <button type="button" className="w-10 h-10 border hover:border-gray-800 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">SM</button>
                <button type="button" className="w-10 h-10 border hover:border-gray-800 border-gray-800 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">MD</button>
                <button type="button" className="w-10 h-10 border hover:border-gray-800 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">LG</button>
                <button type="button" className="w-10 h-10 border hover:border-gray-800 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">XL</button>
              </div>
            </div>

            <div className="mt-6 space-y-4">
              <button type="button" className="w-full px-4 py-2.5 border border-gray-800 bg-transparent hover:bg-gray-50 text-gray-800 text-sm font-semibold rounded-md">Add to cart</button>
              <button type="button" className="w-full px-4 py-2.5 border border-gray-800 bg-gray-800 hover:bg-gray-900 text-white text-sm font-semibold rounded-md">Buy now</button>
            </div>
            ...
            <div className="mt-6">
              ...
              <ul className="space-y-3 list-disc mt-4 pl-4 text-sm text-gray-500">
      ...
      </div><div className="font-sans p-8 tracking-wide max-w-7xl max-lg:max-w-2xl max-lg:mx-auto">
          <div>
            <h2 className="text-xl font-bold text-gray-800">Dark blue sneakers with white laces</h2>
            <p className="text-sm text-gray-500 mt-2">Well-Versed Commerce</p>
          </div>
          ...
          <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-8 mt-6">
            <div className="lg:col-span-3">
              <div className="grid sm:grid-cols-3 gap-2 text-center">
                <div className="sm:col-span-2 bg-gray-100 p-4 flex items-center rounded">
                  <img src="https://readymadeui.com/images/product14.webp" alt="Product" className="w-full aspect-[5/4] object-contain object-top" />
                </div>
            ...
            <div className="w-full lg:col-span-2">
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-wrap gap-4 mt-4">
                  <button type="button" className="w-12 h-12 border hover:border-purple-600 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">SM</button>
                  <button type="button" className="w-12 h-12 border hover:border-purple-600 border-purple-600 font-semibold text-purple-800 text-sm rounded-full flex items-center justify-center shrink-0">MD</button>
                  <button type="button" className="w-12 h-12 border hover:border-purple-600 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">LG</button>
                  <button type="button" className="w-12 h-12 border hover:border-purple-600 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">XL</button>
                </div>
              </div>

              <div className="flex gap-4 mt-6">
                <button type="button" className="w-full px-4 py-3 bg-purple-600 hover:bg-purple-700 text-white text-sm font-semibold rounded">Buy now</button>
                <button type="button" className="w-full px-4 py-2.5 border border-purple-600 bg-transparent hover:bg-gray-50 text-gray-800 text-sm font-semibold rounded">Add to cart</button>
              </div>
              ...
              <div className="mt-6">
                ...
                <div className='flex items-center gap-2 mt-4'>
                  <input type='number'
                    placeholder='Enter pincode' className='bg-white px-4 py-2.5 text-sm w-full border border-gray-300 outline-0 rounded' />
                  <button type='button' className='border border-purple-600 outline-0 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2.5 text-sm rounded'>Apply</button>
                </div>
              </div>
            </div>
          </div>

...
export default function Header(){
    ...
    <div className='w-full flex flex-wrap items-center lg:gap-y-4 gap-y-6 gap-x-4 relative'></div>
      <p className="font-bold text-4xl">SANIYA</p>
      </header>
      ...
      <div id="collapseMenu"
        ...
        <ul
          ...
          <li className='max-lg:border-b max-lg:py-3 px-3'><a href="/product-list"
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>Product List</a></li>
          <li className='max-lg:border-b max-lg:py-3 px-3'><a href="/product-view"
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>Product View</a></li>
          <li className='max-lg:border-b max-lg:py-3 px-3'><a href="/shopping-card"
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>Shopping Card</a></li>
          <li className='max-lg:border-b max-lg:py-3 px-3'><a href="/checkout-form"
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>Checkout Form</a></li>
          <li className='max-lg:border-b max-lg:py-3 px-3'><a href="/sign-in"
            className='hover:text-yellow-300 text-white text-[15px] font-medium block'>Sign In</a></li>
        </ul>
      </div>
    </header>
    )

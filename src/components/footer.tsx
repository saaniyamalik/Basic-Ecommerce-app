export default function Footer () {
    ...
    return (
        ...
        <footer className="bg-gray-900 pt-12 pb-6 px-10 font-[sans-serif] tracking-wide">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:flex lg:items-center">
            <a href="javascript:void(0)">
              <img src="image/sm.jpg" alt="logo" className="w-48" />
            </a>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 pl-2">
              <li>
                <a className="text-gray-300 hover:text-white text-sm">Featured</a>
              </li>
              <li>
                <a className="text-gray-300 hover:text-white text-sm">New Arrivals</a>
              </li>
              <li>
                <a className="text-gray-300 hover:text-white text-sm">New Arrivals</a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4 pl-2">
              ...
              <li>
                <a  className="text-gray-300 hover:text-white text-sm">Sale</a>
              </li>
              <li>
                <a  className="text-gray-300 hover:text-white text-sm">Documentation</a>
              </li>
            </ul>
          </div>
        </div>

        <p className='text-gray-300 text-sm mt-10'>©2025_ Saaniya Malik . All rights reserved.
        </p>
      </div>
    </footer>
    )
